...
class RepositoryTest {
    ...
    void setUp() {
        ...
        patRepo.add(1, new Cake(1, "name1", "phone1", "a1"));
        patRepo.add(2, new Cake(2, "name2", "phone2", "a2"));
        patRepo.add(3, new Cake(3, "name3", "phone3", "a3"));
    }

    @Test
    void addCake() {
        Cake p4 = new Cake(4, "name4", "phone4", "a4");
